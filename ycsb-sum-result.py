...
def fill_summary_fdb(workbook, sheet,row_idx,sheetname,dbsize,dbsize_sheet,suffix):
    num_format = workbook.add_format()
    num_format.set_num_format('#,##0.0')
    ...
    for i in range(0, len(sheetname)):
        ...
        if 'intel' in wksheet:
            # 如果是intel或者Micron的ssd, logical size = physical size
            # if 'vanda' not in wksheet: # 如果是intel或者Micron的ssd,
    ...
    for result_dir in result_dirs:
        ...
        for d in dir_list:
            ...
            if os.path.exists(dir_path) and os.path.isdir(dir_path):
                ...
                summary_row_idx = fill_summary_fdb(workbook,summary_sheet,summary_row_idx,sheets_list,
